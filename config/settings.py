...
# DEBUG defaults to False for security. Set DEBUG=True for local development.
...
# Uses DATABASE_URL environment variable if set (Railway/production)
...
LOGIN_REDIRECT_URL = '/lab/portfolio-v3/'
LOGOUT_REDIRECT_URL = '/'
